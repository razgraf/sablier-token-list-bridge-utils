    ...
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            return _context2.abrupt("return", JSON.parse(readFileSync(path).toString()));
                ...
                return _regeneratorRuntime.wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        localFileExists = existsSync(pathOrUrl);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            arbProvider = new providers.JsonRpcProvider(l2Rpc(l2Network.chainID));
            ethProvider = new providers.JsonRpcProvider(process.env.MAINNET_RPC);
            _context.next = 16;
  ...
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(l1TokenAddresses, multiCaller, l1GatewayRouterAddress) {
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            iFace = L1GatewayRouter__factory.createInterface();
            _context.next = 3;
...
var web3 = /*#__PURE__*/new Web3(); // chains we support fetching mappings for (can be different than the l2ChainIds arg for buildList)
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            childTokenAddress = childToken ? ethers.utils.getAddress(typeof childToken === 'object' ? childToken.childToken : childToken) : undefined;
...
function mergeTokenLists(primary, secondary) {
  ...
  var grouped = groupBy([].concat(secondary.tokens, primary.tokens), function (t) {
  ...
  var merged = Object.values(grouped).map(function (group) {
    ...
    var merged = merge(group[0], group[1]);
  ...
  return cloneDeep(_extends({}, primary, {
    tokens: merged.sort(compareTokenInfos)
  }));
}

export { chainify, chainifyTokenList, mergeTokenLists };
//# sourceMappingURL=token-list-bridge-utils.esm.js.map
